    ...
    >
      ...
      <div className="relative mx-auto max-w-5xl px-6 text-center lg:px-10">
        ...
        <p className="mx-auto mt-8 max-w-xl text-pearl/65 text-pretty">
          Uma mensagem de distância. Reserve um motorista para amanhã de manhã,
          ou solicite uma unidade SOS para suas coordenadas exatas agora mesmo.
        </p>
        ...
        <div className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="group inline-flex min-w-65 items-center justify-center gap-3 rounded-full bg-whatsapp px-8 py-4 text-sm font-medium text-pearl shadow-[0_20px_60px_-20px_oklch(0.62_0.16_145/0.6)] ring-1 ring-whatsapp transition-transform hover:scale-[1.02]"
          >
          ...
          <a
            href={`tel:${site.whatsappSOS}`}
            className="inline-flex min-w-65 items-center justify-center gap-3 rounded-full border border-pearl/20 bg-pearl/5 px-8 py-4 text-sm font-medium text-pearl backdrop-blur transition-colors hover:bg-pearl/10"
          >
            Ligar para central
          </a>
        </div>
